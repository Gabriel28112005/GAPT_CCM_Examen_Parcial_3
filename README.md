...
https://github.com/Gabriel28112005/GAPT_CCM_Examen_Parcial_3.git
...
-a)(se ha utilizado chat gpt porque había dudas entre dos preguntas)
...
-La implementación de una estructura en c y en c++ se hace de la misma forma. La unica diferencia es que en c se define como struct y en c++ como class.
...
-En el apartado de c se ha utilizado chat gpt para guiarnos en la creación de la funcion mostrar
...
-En los dos ultimos apartados hemos utilizado chat gpt para orientarnos en la creación del sistema de asistencias y si había que introducir la estructura asitencia dentro de la estructura estudiante.
...
-He preguntado a chat gpt y me ha proporcionado este codigo que explicare a continuacion
...
-Dentro de la funcion main existe un puntero "ptr", el cual esta apuntando a malloc(sizeof(int)), que es la instancia de la clase. Basicamente se utiliza un if que devuelve un 1 de la función main si la clase es NULL(nula, o dirección de memoria inesperada) y que en pantalla se muestre "Error: no se ha podido asignar memoria". En nuestro código se podría implementar de la misma forma con nuestra clase estudiante. Cabe recalcar que esta no es la única manera de realizar un manejo de errores en C, pero es la que mas nos ha gustado.
